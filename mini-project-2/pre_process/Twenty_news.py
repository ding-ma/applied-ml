...
twenty_news_train_df = pd.DataFrame(
    data={"target": twenty_news_group_train.target, "train_or_test": "train", "sentence": twenty_news_group_train.data}
)
twenty_news_test_df = pd.DataFrame(
    data={"target": twenty_news_group_test.target, "train_or_test": "test", "sentence": twenty_news_group_test.data}
)
twenty_news_combined_df = twenty_news_train_df.append(twenty_news_test_df)


twenty_news_combined_df["sentence"] = twenty_news_combined_df["sentence"].apply(
